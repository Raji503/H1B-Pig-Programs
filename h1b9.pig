h1b = load '/home/hduser/Downloads/h1bpig' using PigStorage('\t') as (sno, casestatus:chararray, employername:chararray, socname, jobtitle, position, wage, year, lat, log);

--h1b10 = h1b limit 10;

--dump h1b10;

h1bfilter = foreach h1b generate employername, casestatus;

group1 = group h1bfilter by employername;
...
group2 = group csfilter by employername;
