h1b = load '/home/hduser/Downloads/h1bpig' using PigStorage('\t') as (sno, casestatus, employername, socname, jobtitle:chararray, position, wage:double, year:chararray, lat, log);
